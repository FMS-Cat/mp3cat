...
var post = function post(url, obj, callback) {
  var fd = new FormData();
  for (var key in obj) {
...
var formatTime = function formatTime(sec) {
  ...
  var s = ("0" + Math.floor(sec) % 60).slice(-2);
  var m = ("0" + Math.floor(sec / 60) % 60).slice(-2);
  var h = ("0" + Math.floor(sec / 60 / 60) % 60).slice(-2);
  if (h === "00") {
    return m + ":" + s;
  } else {
    return h + ":" + m + ":" + s;
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      filelistAttrs: [{ field: "artist", width: 100 }, { field: "title", width: 120 }, { field: "album", width: 100 }],
      ...
      flicker: {
        ...
        func: { center: function center() {}, left: function left() {}, right: function right() {}, up: function up() {}, down: function down() {} }
      }
    };
  },
  ...
  watch: {
    filelistAttrs: function filelistAttrs(value) {
      this.saveStorage("filelistAttrs", value);
    },
    sortValue: function sortValue(value) {
  ...
  methods: {
    ...
    loadStorage: function loadStorage() {
      if (localStorage["mp3cat"]) {
        ...
        if (json) {
          if (json.sortValue) {
            this.sortValue = json.sortValue;
          }
          if (json.searchValue) {
            this.searchValue = json.searchValue;
          }
          if (json.filelistAttrs) {
            this.filelistAttrs = json.filelistAttrs;
          }
        }
      }
    },
    ...
    getArtistTitleString: function getArtistTitleString(file) {
      var queryArray = [];
      if (file.artist) {
        queryArray.push(file.artist);
      }
      if (file.title) {
        queryArray.push(file.title);
      }
    ...
    loadMusic: function loadMusic(file, index) {
      this.pause();
    ...
    playMusic: function playMusic(file) {
    ...
    playerCanPlay: function playerCanPlay() {
      this.play();
    },
    playerEnded: function playerEnded() {
      this.playNext(1);
    },
    playNext: function playNext(dir) {
      var _this = this;
      ...
      var url = "./list";
      var sort = this.playlist.sort;
      url += "?sort=" + sort;
      var search = this.playlist.search;
      url += "&search=" + search;
      url += "&limit=1";
      ...
      get(url, function (status, res) {
        ...
        if (list.length !== 0) {
          _this.playMusic(list[0]);
        }
      });
    },
    getPlaylistCount: function getPlaylistCount(callback) {
      var _this2 = this;
      ...
      get(url, function (status, res) {
        ...
        _this2.playlist.count = count;
      });
    },
    downloadMusic: function downloadMusic(file) {
    ...
    editFile: function editFile(file) {
      this.editing = true;
      this.editingFile = (0, _assign2.default)({}, file);
      this.editingCover = null;
      this.editingCoverURL = "./cover/" + this.editingFile.path;
      this.editingBulk = false;
    },
    toggleBulk: function toggleBulk() {
      if (this.editingBulk) {
        for (var key in this.editingFile) {
          this.editingFile[key] = "***" + this.editingFile[key];
        }
      } else {
        for (var _key in this.editingFile) {
          if (this.editingFile[_key].substring(0, 3) === "***") ;
          this.editingFile[_key] = this.editingFile[_key].substring(3);
        }
      }
    },
    editFileOK: function editFileOK() {
      var _this3 = this;
    ...
    editFileCancel: function editFileCancel() {
      this.editing = false;
    },
    ...
    searchFile: function searchFile(file) {
      var query = this.getArtistTitleString(file);
    ...
    onSearchBoxInput: function onSearchBoxInput() {
      ...
      var id = this.searchBoxInputId;
      setTimeout(function () {
        if (id === _this6.searchBoxInputId) {
          _this6.list();
        }
      }, 250);
    },
    flickerMusic: function flickerMusic(file, index) {
      var _this7 = this;
      ...
      this.flicker = {
        ...
        func: {
          center: function center() {
            _this7.loadMusic(file, index);
          },
          left: function left() {
            _this7.removeFile(file);
          },
          right: function right() {
            _this7.editFile(file);
          },
          up: function up() {
            _this7.searchFile(file);
          },
          down: function down() {
            _this7.downloadMusic(file);
          }
        }
      };
    },
    flickerDone: function flickerDone() {
    ...
    onEditorKeyDown: function onEditorKeyDown(event) {
      if (event.which === 13) {
        event.preventDefault();
        this.editFileOK();
    ...
    onEditorKeyDownBPM: function onEditorKeyDownBPM(event) {
      if (event.which === 32) {
        event.preventDefault();
        this.editingFile.bpm = Math.floor((0, _tap2.default)() * 100) / 100;
      } else {
    ...
    onCoverDrop: function onCoverDrop(event) {
      var _this9 = this;
      ...
      if (files && files[0]) {
        ...
        reader.onload = function () {
          _this9.editingCoverURL = reader.result;
        };
        reader.readAsDataURL(files[0]);
      }
    },
    grabFilelistAttr: function grabFilelistAttr(attr) {
      var _this10 = this;
      ...
      var move = function move(event) {
        ...
        var index = _this10.filelistAttrs.indexOf(attr);
        if (deltaX < -10 && index !== 0) {
          _this10.filelistAttrs.splice(index - 1, 2, attr, _this10.filelistAttrs[index - 1]);
          deltaX = 0;
        }
        if (10 < deltaX && index !== _this10.filelistAttrs.length - 1) {
          _this10.filelistAttrs.splice(index, 2, _this10.filelistAttrs[index + 1], attr);
          deltaX = 0;
        }
      };
      ...
      var up = function up() {
        if (notmoved) {
          var sortArray = _this10.sortValue.split(",");

          var existed = sortArray.indexOf(attr.field);
          var iexisted = sortArray.indexOf("-" + attr.field);
          ...
          _this10.sortValue = sortArray.join(",");
    ...
    addFilelistAttr: function addFilelistAttr(event) {
    ...
    removeFilelistAttr: function removeFilelistAttr(attr) {
      var index = this.filelistAttrs.indexOf(attr);
      this.filelistAttrs.splice(index, 1);

      this.filelistMenu.show = false;
    },
    grabFilelistResizer: function grabFilelistResizer(attr) {
      var _this11 = this;
      ...
      var up = function up() {
        var temp = _this11.filelistAttrs;
        _this11.filelistAttrs = {};
        _this11.filelistAttrs = temp;
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-1fa650a7", __vue__options__)
  }
})()}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.reload("data-v-256aa696", __vue__options__)
  }
})()}
...
exports.default = {
  props: ["src"],
  methods: {
    escapeShit: function escapeShit(str) {
      str = str.replace(/\(/g, "\\(");
      str = str.replace(/\)/g, "\\)");
      str = str.replace(/\'/g, "\\)");
      return str;
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"cover-cover",style:({ backgroundImage: 'url(' + _vm.escapeShit( _vm.src ) + ')' })})}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
exports.default = {
  props: ["active", "imageSrcCenter", "imageSrcLeft", "imageSrcRight", "imageSrcDown", "imageSrcUp", "onCenter", "onLeft", "onRight", "onUp", "onDown"],
  ...
  methods: {
    ...
    onMouseUp: function onMouseUp(event) {
      this.$emit("done");
      if (this.dir === "center" && typeof this.onCenter === "function") {
        this.onCenter();
      } else if (this.dir === "left" && typeof this.onLeft === "function") {
        this.onLeft();
      } else if (this.dir === "right" && typeof this.onRight === "function") {
        this.onRight();
      } else if (this.dir === "up" && typeof this.onUp === "function") {
        this.onUp();
      } else if (this.dir === "down" && typeof this.onDown === "function") {
        this.onDown();
      }
    ...
    moveDecay: function moveDecay() {
      var deltaTime = 1.0 / 60.0;
      this.moveX *= Math.exp(-deltaTime * 3.0);
      this.moveY *= Math.exp(-deltaTime * 3.0);

      var r = Math.sqrt(this.moveX * this.moveX + this.moveY * this.moveY);
      this.dir = "center";
      if (10 < r) {
      ...
      if (this.active) {
        requestAnimationFrame(this.moveDecay);
      }
    }
  }
};
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"flicker",class:{ active: _vm.active },on:{"mousemove":function($event){$event.stopPropagation();_vm.onMouseMove($event)},"mouseup":function($event){$event.stopPropagation();_vm.onMouseUp($event)}}},[_c('div',{staticClass:"bg"}),_vm._v(" "),_c('div',{staticClass:"imageContainer"},[_c('img',{staticClass:"image imageCenter",class:{ selected: _vm.dir === 'center' },attrs:{"src":_vm.imageSrcCenter}}),_vm._v(" "),_c('img',{staticClass:"image imageLeft",class:{ selected: _vm.dir === 'left' },attrs:{"src":_vm.imageSrcLeft}}),_vm._v(" "),_c('img',{staticClass:"image imageRight",class:{ selected: _vm.dir === 'right' },attrs:{"src":_vm.imageSrcRight}}),_vm._v(" "),_c('img',{staticClass:"image imageUp",class:{ selected: _vm.dir === 'up' },attrs:{"src":_vm.imageSrcUp}}),_vm._v(" "),_c('img',{staticClass:"image imageDown",class:{ selected: _vm.dir === 'down' },attrs:{"src":_vm.imageSrcDown}})])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"./app.vue":"/Users/Yutaka/Dropbox/pro/JavaScript/_nodejs/mp3cat/src/app.vue","vue":"/Users/Yutaka/Dropbox/pro/JavaScript/_nodejs/mp3cat/node_modules/vue/dist/vue.runtime.common.js"}],"/Users/Yutaka/Dropbox/pro/JavaScript/_nodejs/mp3cat/src/tap.js":[function(require,module,exports){
"use strict";
...
},{}]},{},["/Users/Yutaka/Dropbox/pro/JavaScript/_nodejs/mp3cat/src/main.js"]);
